...
namespace NUnitTestProject1
{
    class MathTests
    {
        ...
        {
            var result = shipMath.GenerateRowNr(3,18);
        ...
        {
            var result = shipMath.GenerateRowNr(6,9);
            Assert.That(result, Is.EqualTo(7));
        }
        ...
        {
            var result = shipMath.GenerateRowNr(10,11);
            Assert.That(result, Is.EqualTo(10));
        }
        ...
        {
            var result = shipMath.GenerateRowNr(2,15);
